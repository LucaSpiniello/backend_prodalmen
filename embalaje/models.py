...
class Embalaje(ModeloBaseHistorico):
    ...
    calidad                 = models.CharField(max_length=16, choices=CALIDAD, blank=True)
    calibre                 = models.CharField(max_length=16, choices=CALIBRES, blank=True)
    variedad                = models.CharField(max_length=16, choices=VARIEDAD, blank=True)
